package com.gaston.homebanking.main;

import java.util.Scanner;
import com.gaston.homebanking.model.Banco;
import com.gaston.homebanking.model.CuentaBancaria;
import com.gaston.homebanking.ui.Menu;
...
public class Main {
    ...
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in); // Escáner para entrada de usuario
        Banco banco = new Banco();           // Banco que contiene las cuentas
        CuentaBancaria cuentaActiva = null;  // Cuenta actualmente activa = null

package com.gaston.homebanking.ui;
...
public class Menu {
    ...
    public static void subMenuCuenta(CuentaBancaria cuenta, Scanner sc){
        ...
        do{
            ...
            manejarOpcionSubMenu(opcion, cuenta, sc);
     ...
     * @param sc Scanner para leer la entrada del usuario
     */
    public static void manejarOpcionSubMenu(String opcion, CuentaBancaria cuenta, Scanner sc) {
        switch (opcion) {
